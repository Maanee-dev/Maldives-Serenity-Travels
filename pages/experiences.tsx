...
const Experiences: React.FC = () => {
  ...
  return (
    <div className="bg-parchment dark:bg-slate-950 min-h-screen selection:bg-sky-100 selection:text-sky-900 transition-colors duration-700">
      ...
      {/* Category Navigation - Dark Adaptive */}
            ...
            {spotlightExperience && (
              <section className="reveal">
                 <div className="flex flex-col lg:flex-row gap-16 lg:gap-32 items-center">
                    <div className="lg:w-3/5 relative aspect-[16/9] w-full rounded-[3rem] md:rounded-[5rem] overflow-hidden shadow-2xl group dark:shadow-slate-900/50">
                       ...
                       <div className="absolute top-10 left-10">
                          <span className="bg-white/95 dark:bg-slate-900/90 backdrop-blur-md px-6 py-2 rounded-full text-[9px] font-black text-slate-950 dark:text-white uppercase tracking-[0.4em] shadow-lg border dark:border-white/5">
                            Spotlight Journey
                          </span>
                       </div>
                    </div>
      ...
      <section className="py-32 md:py-64 bg-white dark:bg-slate-950 transition-colors duration-700 reveal">
         <div className="max-w-[1440px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
            ...
            <div className="lg:col-span-7 aspect-[16/10] rounded-[4rem] overflow-hidden shadow-2xl bg-slate-100 dark:bg-slate-900 dark:shadow-slate-900/50">
      ...
      {/* CTA Footer */}
      <section className="py-48 bg-slate-950 text-white relative overflow-hidden text-center transition-colors">
