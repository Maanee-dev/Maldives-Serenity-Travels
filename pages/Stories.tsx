...
const Stories: React.FC = () => {
  ...
  // Safe access to the latest dispatch
  const featuredPost = dispatches.length > 0 ? dispatches[0] : (BLOG_POSTS.length > 0 ? BLOG_POSTS[0] : null);
  ...
  return (
    <div className="bg-[#FCFAF7] min-h-screen">
      <div className="max-w-7xl mx-auto px-6 py-48 md:py-64 lg:px-12">
        ...
        {/* Featured Latest Dispatch - Only render if a post exists */}
        {featuredPost ? (
          <div className="mb-48">
            <Link 
            ...
            >
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex items-center gap-6 justify-center">
                   ...
                   <span className="text-slate-900 font-bold text-[10px] uppercase tracking-[0.4em]">{featuredPost.author}</span>
                </div>
              </div>
            </Link>
          </div>
        ) : (
          <div className="py-20 text-center text-slate-300 uppercase tracking-[0.5em] text-xs">No dispatches available at this moment.</div>
        )}
