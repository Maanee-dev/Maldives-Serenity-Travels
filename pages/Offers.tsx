  ...
  useEffect(() => {
    const fetchOffers = async () => {
      ...
      try {
        ...
        // In a real app, we'd map new DB fields. For this demo, we use a robust fallback.
        if (offersData && offersData.length > 0) {
          // We enhance the DB data with UI fields for the demo
