    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-[#FCFAF7]">
        <div className="text-center max-w-2xl reveal active">
           ...
           <Link to="/" className="text-[10px] font-bold uppercase tracking-[0.8em] text-slate-950 border-b border-slate-950 pb-3 hover:text-sky-500 hover:border-sky-500 transition-all duration-700">Return Home</Link>
        </div>
      </div>
    );
  }
                ...
                {[
                  ...
                  <div key={row.key} className="flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-center gap-4">
                      ...
                      <span className="text-[10px] font-serif italic text-slate-300">or</span>
                      <button
          ...
          {step === 4 && (
            <div className="space-y-16 animate-in fade-in slide-in-from-bottom-6 duration-700">
              ...
              <div className="max-w-xl mx-auto space-y-12">
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-slate-50 border-b border-slate-100 rounded-[2rem] px-10 py-6 text-[11px] font-bold uppercase tracking-[0.4em] outline-none focus:bg-white focus:border-sky-300 transition-all shadow-sm placeholder:text-slate-200"
                  />
              ...
              <div className="flex flex-col items-center gap-8 pt-12">
                <button onClick={nextStep} className="bg-slate-950 text-white font-bold px-16 py-7 rounded-full text-[11px] uppercase tracking-[0.5em] hover:bg-sky-500 transition-all shadow-2xl">Continue to Final Step</button>
                <button onClick={prevStep} className="text-slate-300 font-bold uppercase tracking-widest text-[9px] hover:text-slate-950 transition-colors">← Back</button>
              </div>
            </div>
          )}
          ...
          {step === 5 && (
            <div className="space-y-16 animate-in fade-in slide-in-from-bottom-6 duration-700">
              <div className="text-center">
                ...
                <h3 className="text-3xl md:text-5xl font-serif font-bold text-slate-900 tracking-tighter italic">Almost there!</h3>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-10 max-w-4xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <select value={finalDetails.mealPlan} onChange={e => setFinalDetails(prev => ({...prev, mealPlan: e.target.value}))} className="w-full bg-slate-50 border-b border-slate-100 rounded-2xl px-8 py-5 text-[12px] font-bold uppercase tracking-widest focus:bg-white outline-none focus:border-sky-300 transition-all appearance-none">
