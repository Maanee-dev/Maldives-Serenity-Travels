            ...
            <form onSubmit={handleSearch} className="w-full max-w-xl reveal active delay-500">
              <div className="relative group">
                {/* 
                  ...
                  We use 'text-base' (16px) on mobile and 'md:text-[11px]' to restore the brand look on larger screens.
                */}
                <input 
                  type="text" 
                  value={searchQuery} 
                  ...
                  className="w-full bg-white/5 backdrop-blur-3xl border border-white/20 rounded-full pl-10 pr-24 py-6 text-white text-base md:text-[11px] font-bold uppercase tracking-[0.4em] outline-none focus:bg-white focus:text-slate-950 placeholder:text-white/30 shadow-2xl" 
                />
