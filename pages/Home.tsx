      ...
      <section className="relative h-[100svh] w-full flex items-center justify-center overflow-hidden bg-slate-950">
        ...
        <div className="relative z-10 w-full max-w-[1600px] px-6 sm:px-12 md:px-20">
          <div className="flex flex-col items-start text-left">
            ...
            <form onSubmit={handleSearch} className="w-full max-xl reveal active delay-500">
              <div className="relative group">
                {/* 
                  To prevent auto-zoom on mobile devices (iOS), the input font-size must be at least 16px.
                  We use 'text-[16px]' for mobile and 'lg:text-[11px]' to restore the brand look on laptops/desktops.
                */}
                <input 
                  type="text" 
                  value={searchQuery} 
                  ...
                  className="w-full bg-white/5 backdrop-blur-3xl border border-white/20 rounded-full pl-10 pr-24 py-6 text-white text-[16px] lg:text-[11px] font-bold uppercase tracking-[0.4em] outline-none focus:bg-white focus:text-slate-950 placeholder:text-white/30 shadow-2xl" 
                />
