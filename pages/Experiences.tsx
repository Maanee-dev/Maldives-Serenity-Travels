    ...
    <div className="bg-[#FCFAF7] min-h-screen">
      <section className="pt-64 pb-48 px-6 text-center reveal">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-500 text-[11px] font-bold max-w-xl mx-auto uppercase tracking-[0.5em] leading-[2.8] opacity-80">Beyond the turquoise horizon lies a world <br className="hidden md:block"/> defined by movement, silence, and adventure.</p>
        </div>
      </section>
            ...
            <div key={exp.id} className={`flex flex-col lg:flex-row gap-24 lg:gap-48 items-center reveal ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
               ...
               <div className="lg:w-1/2">
                  <div className="max-w-xl">
                    ...
                    <p className="text-slate-500 text-lg md:text-xl leading-[2.2] mb-16 font-medium opacity-85">{exp.description} Discover the Maldives through private expeditions, castaway retreats, and rhythmic local culture designed for your unique perspective.</p>
      ...
      <section className="py-64 bg-white reveal">
         <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
            <div className="lg:col-span-5">
               ...
               <p className="text-slate-500 text-lg leading-[2.2] mb-16 opacity-90">From chartered seaplanes to luxury yacht transfers and private jet handling at Velana International. We manage the mechanics of your arrival so you can remain in the moment.</p>
      ...
      <section className="py-64 bg-slate-950 text-white overflow-hidden relative">
         ...
         <div className="max-w-4xl mx-auto px-6 text-center reveal relative z-10">
            ...
            <p className="text-slate-400 text-sm md:text-lg font-medium leading-loose mb-24 opacity-80 uppercase tracking-[0.5em]">If it exists in the Maldivian Atolls, we curate it. <br className="hidden md:block"/> From sandbank soirées to deep-sea explorations.</p>
            <Link to="/plan" className="inline-block bg-white text-slate-950 font-bold px-16 py-7 rounded-full hover:bg-sky-400 hover:text-white transition-all duration-700 uppercase tracking-[0.5em] text-[10px] shadow-2xl">Consult An Expert</Link>
         </div>
      </section>
    </div>
  );
