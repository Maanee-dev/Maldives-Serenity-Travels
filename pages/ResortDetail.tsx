...
const ResortDetail: React.FC = () => {
  ...
  return (
    <div className="bg-[#FCFAF7] min-h-screen selection:bg-sky-100 selection:text-sky-900 pb-32">
      ...
      {/* 2. INTRO SECTION - Grid Split for Essence & Inquiry */}
      ...
      {/* 4. FULL WIDTH CULINARY PERSPECTIVE */}
      ...
      {/* 5. WELLNESS & SUSTAINABILITY - Centered Finales */}
      <section className="max-w-[1440px] mx-auto px-6 mt-40 md:mt-64 space-y-32">
        
        {/* Wellness Rituals */}
        <div className="reveal bg-white rounded-[5rem] p-12 md:p-32 shadow-sm border border-slate-50 relative overflow-hidden text-center">
        ...
        <div className="bg-slate-950 rounded-[5rem] p-12 md:p-32 text-white reveal relative overflow-hidden group text-center">
