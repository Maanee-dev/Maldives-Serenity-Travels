...
// Updated to use PascalCase to match the canonical component file names 'Offers.tsx'
import Offers from './pages/Offers';
// Updated to use PascalCase to match the canonical component file names 'Experiences.tsx'
