...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white dark:bg-slate-950 pt-24 pb-12 border-t border-slate-100 dark:border-white/5 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-slate-600 dark:text-slate-400 text-[10px] uppercase font-bold tracking-widest">
            ...
            <ul className="space-y-4">
              <li>
                <a 
                  ...
                  className="flex items-center gap-3 text-slate-600 dark:text-slate-400 hover:text-slate-950 dark:hover:text-white transition-colors group"
                >
        ...
        <div className="pt-12 border-t border-slate-50 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-slate-400 dark:text-slate-500 text-[9px] font-bold uppercase tracking-[0.4em]">
